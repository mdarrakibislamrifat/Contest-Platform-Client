              ...
              <>
                <li>
                  <NavLink to="/dashboard/addcontest">
                    <FaFileImport className="text-xl"></FaFileImport> Add
                    Contest
                  </NavLink>
                </li>
                <li>
                  <NavLink to="/dashboard/createdcontest">
                    <FaList className="text-xl"></FaList> My Created Contest
                  </NavLink>
                </li>
                <li>
                  <NavLink to="/dashboard/contestsubmit">
                    <FaFileCircleCheck className="text-xl"></FaFileCircleCheck>{" "}
                    Contest Submit
                  </NavLink>
                </li>
              </>
              ...
              <>
                <li>
                  <NavLink to="/dashboard/participatecontest">
                    <FaCartPlus className="text-xl"></FaCartPlus> My
                    Participated Contest
                  </NavLink>
                </li>
                <li>
                  <NavLink to="/dashboard/winningcontest">
                    <FaStar className="text-xl"></FaStar> My Winning Contest
                  </NavLink>
                </li>
                <li>
                  <NavLink to="/dashboard/myprofile">
                    <IoIosContact className="text-xl"></IoIosContact> My Profile
                  </NavLink>
                </li>
              </>
            ) : (
